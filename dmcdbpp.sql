...
#Book apppointment
insert into request_table  (requestId, date, time, remark, status, patientId, docId, dgserviceId, agentId) values (1, '2020-06-20', '23:58:00', 'Vestibulum sed magna at nunc commodo placerat.', "Yes", 1, 1, 1, 1);
insert into request_table  (requestId, date, time, remark, status, patientId, docId, dgserviceId, agentId) values (2, '2020-07-03', '10:36:00', 'Curabitur convallis.', "Yes", 2, 2, 2, 2);
insert into request_table  (requestId, date, time, remark, status, patientId, docId, dgserviceId, agentId) values (3, '2020-07-02', '21:26:00', 'Aliquam non mauris.', "Yes", 3, 3, 3, 3);
insert into request_table  (requestId, date, time, remark, status, patientId, docId, dgserviceId, agentId) values (4, '2021-02-02', '4:30:00', 'In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem.', "Yes", 4, 4, 4, 4);
