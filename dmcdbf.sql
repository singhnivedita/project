...
insert into admin_table (adminId, firstName, lastName, password, roleId) values (1, 'Broderick', 'Schwerin', 'Z9amFj1r', 2);
insert into admin_table (adminId, firstName, lastName, password, roleId) values (2, 'Pearce', 'Milroy', 'EIXLYY', 2);
insert into admin_table (adminId, firstName, lastName, password, roleId) values (3, 'Connie', 'Buttner', '9Nq6Qg53nNY', 2);
insert into admin_table (adminId, firstName, lastName, password, roleId) values (4, 'Obediah', 'Whitehurst', 'edMZ5rpQj', 2);

insert into admin_table ( firstName, lastName, password, roleId) values ('Rocky', 'Abraham', 'handsome@123', 2);

#agent table
desc agent_table;
select * from agent_table;
insert into agent_table (agentPk, agentId, firstName, lastName, dob, gender, contactNumber, password, email, bankAccNo, bankName, ifsc, roleId) values (1, 1, 'Joel', 'Grewer', '2013-12-16', 'Male', '9803072838', 'yAU1Co0', 'agrewer0@sphinn.com', '1107476364', 'Archie', 'EJ6ZQa0Xb', 4);
insert into agent_table (agentPk, agentId, firstName, lastName, dob, gender, contactNumber, password, email, bankAccNo, bankName, ifsc, roleId) values (2, 2, 'Beck', 'Shelp', '2013-08-26', 'Female', '1140391038', 'MFytSiszSWs', 'gshelp1@princeton.edu', '1317536908', 'Gael', 'AgBoLWEb', 4);
insert into agent_table (agentPk, agentId, firstName, lastName, dob, gender, contactNumber, password, email, bankAccNo, bankName, ifsc, roleId) values (3, 3, 'Alley', 'Cubitt', '2003-07-29', 'Male', '6906087533', 'ZiEv4qnQ', 'ncubitt2@discovery.com', '5104076687', 'Natasha', 'eXqneihnc1F2', 4);
...
insert into agent_table (agentId, firstName, lastName, dob, gender, contactNumber, password, email, bankAccNo, bankName, ifsc, roleId) values (6, 'John', 'Handsome', '2004-11-14', 'Male', '7849094298', 'handsome@1234', 'nprawle3@techcrunch.com', '8833210774', 'Noby', 'rocky', 4);
...
insert into patient_table (patientId, firstName, lastName, dob, gender, contactNumber, password, address, roleId) values (1, 'Michal', 'Carslaw', '2020-10-28', 'Male', '3579918589', 'CMwBGCv6V', '9 Sundown Drive', 3);
insert into patient_table (patientId, firstName, lastName, dob, gender, contactNumber, password, address, roleId) values (2, 'William', 'Sicily', '2020-05-02', 'Bigender', '6975946355', 'WtqPsXs5', '98 Maple Parkway', 3);
...
insert into patient_table (patientId, firstName, lastName, dob, gender, contactNumber, password, address, roleId) values (4, 'Wolfgang', 'Eicke', '2020-04-30', 'Bigender', '7556731355', 'YWJPX6x9onJ', '7 Rockefeller Hill', 3);
insert into patient_table ( firstName, lastName, dob, gender, contactNumber, password, address, roleId) values ('Mohan', 'Srivastav', '2020-04-30', 'Male', '7556731355', 'mohan@123', 'Guwahati, Assam', 3);
