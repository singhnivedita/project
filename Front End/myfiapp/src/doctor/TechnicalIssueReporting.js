...
class TechnicalIssueReportingDoctor  extends React.Component{
   state={
       serviceList:[]
   }
    handleSubmit =(event) =>{
                        ...
                        <div className="wrapper bg-white">
                            ...
                            <div className="h4 text-muted text-center pt-2">Report Technical Issue</div>
                             ...
                             <div className="form-group ">
                                    <div className="form-control input-field"><input placeholder="Your Id " disabled defaultValue={"Your id is "+this.state.userId || ''} required className="" onChange = {e =>this.description = e.target.value }/> </div>
                                </div>
                             ...
                             <br></br>
                                ...
                                <div className="text-center pt-3 ml-auto">Issue Solved? <Link to={"/doctorHome"}> Go Back</Link></div>
                                </div> <button className="btn btn-block text-center my-3">Add</button>
                                <div className="text-center pt-3 text-muted">Issue Solved? <Link to={"/doctorHome"}> Go Back</Link></div>
                            </form> 
...
export default TechnicalIssueReportingDoctor;